  ...
  return (
    <div className="flex justify-center mb-6" style={{ perspective: '300px' }}>
      <motion.div
        ...
        className="relative w-32 h-32 cursor-pointer resume-photo"
      ...
      >
        <div
          className="absolute inset-0 rounded-full overflow-hidden border-4 border-resume-bg/30 shadow-lg resume-photo-front"
        ...
        <div
          className="absolute inset-0 rounded-full border-4 border-resume-bg/30 shadow-lg bg-gradient-to-br from-resume-primary to-resume-primary-light flex items-center justify-center resume-photo-back"
...
export function Sidebar() {
  ...
  return (
    <div className="md:w-[38%] bg-gradient-to-b from-resume-sidebar-from to-resume-sidebar-to p-8 resume-sidebar">
      {/* Photo */}
      {personal.photo && (
        <SidebarPhoto
